...
const Index = () => {
  return <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800">
      {/* Navigation */}
      ...
      <div className="relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 bg-[f9f9fc] bg-[#f9f9fc]">
      ...
      {/* Features Section */}
      <div className="relative from-purple-800 to-purple-900 py-24 bg-[t#] bg-[#f9f9fc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          }].map((feature, idx) => <Card key={idx} className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all duration-300 rounded-2xl shadow-lg hover:shadow-2xl">
      ...
      <div className="relative from-purple-900 to-indigo-900 py-24 bg-[t#] bg-[#f9f9fc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-6">
              How It Works
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            icon: MessageCircle
          }].map((step, idx) => <div key={idx} className="text-center">
